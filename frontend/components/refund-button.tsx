...
export default function RefundButton({ campaignId, provider, account, contribution, onSuccess }: RefundButtonProps) {
  ...
  const handleRefund = async () => {
    try {
      ...
      toast({
        ...
        description: (error as Error).message || "An error occurred while processing your refund",
        variant: "destructive",
      })
    } finally {
      setIsLoading(false)
